 ...
 * (mbe30_inventory_basic/TileEntityInventoryBasic.java)
 * 
 * Original code by:
 * User: brandon3055
 * Date: 06/01/2015
 *
 * This is a simple tile entity implementing IInventory that can store 27 item stacks
 */

public class TileEntityComputerBlock extends TileEntity implements IInventory {
	// Create and initialize the items variable that will store store the items
	final int NUMBER_OF_SLOTS = 27;
	public NonNullList<ItemStack> itemStacks = NonNullList.<ItemStack>withSize(NUMBER_OF_SLOTS, ItemStack.EMPTY);
