...
public class PyCraftGuiFactory implements IModGuiFactory 
{
	...
	{
		return PyCraftConfigGui.class; //tells Forge which class represents our main GUI screen
	}
	...
	public static class PyCraftConfigGui extends GuiConfig 
	{
		public PyCraftConfigGui(GuiScreen parentScreen) 
		{
			//I18n function basically "translates" or localizes the given key using the appropriate .lang file
			super(parentScreen, getConfigElements(), PyCraft.MODID,
		...
		public static class CategoryEntryGeneral extends CategoryEntry
		{
			...
			protected GuiScreen buildChildScreen() 
			{
				...
				Configuration configuration = PyCraftConfiguration.getConfig();
				ConfigElement cat_general = new ConfigElement(configuration.getCategory(PyCraftConfiguration.CATEGORY_NAME_GENERAL));
				...
				return new GuiConfig(this.owningScreen, propertiesOnThisScreen,
						...
						PyCraftConfiguration.CATEGORY_NAME_GENERAL,
